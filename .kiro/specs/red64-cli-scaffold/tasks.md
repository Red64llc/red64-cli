...
- [ ] 1. Establish project foundation and type definitions
- [ ] 1.1 (P) Initialize TypeScript project with Ink dependencies
...
- [ ] 1.2 (P) Define core type system for flow orchestration
...
- [ ] 1.3 (P) Define CLI configuration types
...
- [ ] 1.4 (P) Define agent invocation types
...
- [ ] 2. Implement CLI entry point and argument parsing
- [ ] 2.1 Set up CLI entry point with meow argument parser
...
- [ ] 2.2 Implement global flag parsing and validation
...
- [ ] 3. Build root application component
- [ ] 3.1 Create App component with global context
...
- [ ] 3.2 Implement command routing logic
...
- [ ] 4. Implement terminal UI components
- [ ] 4.1 (P) Create Spinner component wrapper
  - Re-export Spinner from @inkjs/ui with consistent label prop interface
  - Apply "red64" styling conventions
  - _Requirements: 6.2_

- [ ] 4.2 (P) Create StatusLine component with color coding
...
- [ ] 4.3 (P) Create SelectMenu component for interactive selection
...
- [ ] 4.4 (P) Create OutputRegion component for agent output display
...
- [ ] 4.5 (P) Create Header component with branding
...
- [ ] 4.6 (P) Create ProgressBar component wrapper
  - Re-export ProgressBar from @inkjs/ui
  - Accept current, total, and label props
  - Display task counts during implementation phase
  - _Requirements: 6.4_

- [ ] 5. Implement flow state machine
- [ ] 5.1 Implement deterministic state transition function
...
- [ ] 5.2 Implement FlowMachineService interface
...
- [ ] 5.3 Implement HITL approval gates as state transitions
...
- [ ] 6.1 Implement StateStore service for flow persistence
...
- [ ] 6.2 Implement state restoration and validation
...
- [ ] 6.3 Implement flow management operations
...
- [ ] 7. Implement agent invocation interface
- [ ] 7.1 Implement AgentInvoker service core
...
- [ ] 7.2 Implement agent configuration options
...
- [ ] 7.3 Implement real-time output streaming
...
- [ ] 8.2 Implement agent output validation
...
- [ ] 8.3 Implement retry and error recovery
...
- [ ] 9. Implement screen components
- [ ] 9.1 (P) Implement HelpScreen component
...
- [ ] 9.2 (P) Implement InitScreen component shell
...
- [ ] 9.3 (P) Implement StartScreen component shell
...
- [ ] 9.4 (P) Implement ResumeScreen component shell
...
- [ ] 9.5 (P) Implement StatusScreen component shell
...
- [ ] 10.1 Connect App to CommandRouter and screens
...
- [ ] 10.2 Wire FlowStateMachine with StateStore
...
- [ ] 10.3 Wire PhaseExecutor with AgentInvoker
...
- [ ] 10.4 Integrate git operations placeholder
...
- [ ] 10.5 Verify slash command prefix alignment
...
- [ ] 11.1 Validate CLI invocation without arguments displays help
...
- [ ] 11.2 Validate command routing for all commands
...
- [ ] 11.3 Validate global flag behavior
...
- [ ] 11.4 Validate state persistence round-trip
...
- [ ] 11.5 Validate branding consistency
