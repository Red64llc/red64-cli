 ...
 */
export type ExtensionPointDeclaration = 'commands' | 'agents' | 'hooks' | 'services' | 'templates';
/** Runtime array of all extension point values for validation */
export declare const EXTENSION_POINT_VALUES: readonly ExtensionPointDeclaration[];
/**
 ...
 */
export declare function isValidPluginManifest(value: unknown): value is PluginManifest;
/**
 ...
 */
export declare function isValidPluginModule(value: unknown): value is PluginModule;
/**
...
export declare const HOOK_PRIORITY_VALUES: readonly HookPriority[];
/**
 * Numeric ordering map for deterministic hook priority sorting
 */
export declare const HOOK_PRIORITY_ORDER: Record<HookPriority, number>;
/**
...
export declare const WORKFLOW_PHASE_VALUES: readonly WorkflowPhase[];
/**
 * Capabilities that custom agents can declare
 * Requirements: 5.4
 */
export type AgentCapability = 'code-generation' | 'code-review' | 'testing' | 'documentation' | 'refactoring';
/** Runtime array of all agent capability values */
export declare const AGENT_CAPABILITY_VALUES: readonly AgentCapability[];
/**
...
export declare const TEMPLATE_CATEGORY_VALUES: readonly TemplateCategory[];
/**
