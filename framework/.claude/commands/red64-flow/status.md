---
description: Show status of Red64 flow(s)
...
Commands:
  red64-flow status <feature>   View detailed status
  red64-flow resume <feature>   Resume a paused flow
  red64-flow abort <feature>    Abort a flow
```
...
Start a new flow:
  red64-flow start <feature-name> "<description>"

Example:
  red64-flow start user-auth "Add OAuth2 authentication with GitHub"
```
