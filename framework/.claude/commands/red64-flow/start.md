...
Create `.red64/specs/$1/flow-state.json`:
...
Commit:
```bash
git add .red64/specs/$1/flow-state.json
...
Run `/red64:spec-init "$2"` and wait for completion.

Commit:
```bash
git add .red64/specs/$1/
git commit -m "spec($1): initialize specification"
```

## Phase 4: Requirements Generation

Run `/red64:spec-requirements $1` and wait for completion.
...
- Read `.red64/specs/$1/requirements.md`
...
Run `/red64:validate-gap $1` and wait for completion.
...
Run `/red64:spec-design $1` and wait for completion.
...
Run `/red64:validate-design $1` and wait for completion.
...
Run `/red64:spec-tasks $1` and wait for completion.
...
2. Run `/red64:spec-impl $1 {task-id}`
...
Run `/red64:validate-impl $1` and wait for completion.
...
## Spec Artifacts
- [Requirements](.red64/specs/$1/requirements.md)
- [Design](.red64/specs/$1/design.md)
- [Tasks](.red64/specs/$1/tasks.md)

---
*Generated by Red64 Flow Orchestrator*
```
