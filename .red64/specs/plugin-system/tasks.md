...
- [x] 1. Plugin type system and manifest schema
- [x] 1.1 Define all plugin-related TypeScript types and interfaces
...
- [x] 1.2 (P) Implement the manifest validation service using Zod
...
- [x] 1.3 (P) Add new dependencies (zod, semver) and extend core type union
...
- [x] 2. Plugin registry (in-memory extension store)
- [x] 2.1 Implement the central plugin registry
...
- [x] 3. Plugin context (controlled API surface)
- [x] 3.1 Implement the scoped plugin context
...
- [x] 4. Plugin loader (discovery, validation, and activation)
- [x] 4.1 Implement plugin source scanning and discovery
...
- [x] 4.2 Implement dependency-aware loading order and activation
...
- [x] 5. Extension points
- [x] 5.1 (P) Implement the command extension point
...
- [x] 5.2 (P) Implement the agent extension point
...
- [x] 5.3 (P) Implement the hook runner
...
- [x] 5.4 (P) Implement the service extension point
...
- [x] 5.5 (P) Implement the template extension point
...
- [x] 6. Plugin manager (lifecycle operations)
- [x] 6.1 Implement plugin install, uninstall, and update operations
...
- [x] 6.2 Implement enable, disable, and list operations
...
- [x] 6.3 Implement plugin configuration management
...
- [x] 7. Plugin registry and discovery (npm search)
- [x] 7.1 Implement plugin search and info commands
...
- [x] 8. Plugin developer tooling
- [x] 8.1 (P) Implement the plugin scaffold command
...
- [x] 8.2 (P) Implement the plugin validate command
...
- [x] 8.3 Implement dev mode with hot reload
...
- [x] 9. Core service integration
- [x] 9.1 Integrate plugin commands into the command router
...
- [x] 9.2 Integrate plugin agents into the AgentInvoker
...
- [x] 9.3 Integrate workflow hooks into the PhaseExecutor
...
- [x] 9.4 Integrate plugin templates into the TemplateService
...
- [x] 9.5 Integrate plugin loading into the CLI startup sequence
...
- [x] 10. Plugin management UI
- [x] 10.1 Implement the PluginScreen component
...
- [x] 10.2 Extend argument parsing for the plugin command group
...
- [x] 11. Testing
- [x] 11.1 Unit tests for plugin core components
...
- [x] 11.2 Integration tests for plugin loading and lifecycle
...
- [x]*  11.3 Acceptance-criteria-focused test coverage for CLI commands
